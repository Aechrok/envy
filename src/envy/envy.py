...
# Azure
    if azure:
        from envy.services.AzureService import Azure
        svc = Azure()
...
# AWS
        ...
        from envy.services.AwsService import AWS
        svc = AWS()
...
# Google
        ...
        from envy.services.GoogleService import Google
        svc = Google()
        ...
        from envy.services.DopplerService import Doppler
        svc = Doppler()
